...
-----------------------------------------------*/
ENT.Model = {"models/nh2zombies/cook.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 200
...
-- OnDeath for hammer I/O system in some maps
