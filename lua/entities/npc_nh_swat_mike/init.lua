...
-----------------------------------------------*/
ENT.Model = {"models/SWAT/group01/male_03.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = 300
...
ENT.SoundTbl_OnPlayerSight = {"nh2_swat/2_nowtalking.wav","nh2_swat/2_sir2.wav","nh2_swat/2_sir.wav","nh2_swat/2_sirheswakingup2.wav"}
