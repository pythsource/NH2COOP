...
function ENT:CustomOnInitialize()
	...
	if randomstartskin == 1 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) else
	if randomstartskin == 2 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) end
	if randomstartskin == 3 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) self:SetSkin(3) end
	if randomstartskin == 4 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) self:SetSkin(2) end
	if randomstartskin == 5 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) self:SetSkin(1) end
	if randomstartskin == 6 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) end
	if randomstartskin == 7 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) end
	if randomstartskin == 8 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) self:SetSkin(3) end
	if randomstartskin == 9 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) self:SetSkin(2) end
	if randomstartskin == 10 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) self:SetSkin(1) end
	if randomstartskin == 11 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) end
	if randomstartskin == 12 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) end
	if randomstartskin == 13 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) self:SetSkin(2) end
	if randomstartskin == 14 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) self:SetSkin(1) end
	if randomstartskin == 15 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) end
	if randomstartskin == 16 then self:SetModel(Model("models/nh2zombies/surgeon02.mdl")) end
	if randomstartskin == 17 then self:SetModel(Model("models/nh2zombies/surgeon01.mdl")) self:SetSkin(1) end
	end
