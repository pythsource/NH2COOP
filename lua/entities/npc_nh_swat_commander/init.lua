...
-----------------------------------------------*/
ENT.Model = {"models/SWAT/group01/male_02.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = 400
...
ENT.SoundTbl_Idle = {"nh2_swat/idle/3_hangontothatflare.wav","nh2_swat/idle/l_heretheycome.wav","nh2_swat/idle/l_itssmells.wav","nh2_swat/idle/l_ithinkimgonnabesick.wav","nh2_swat/idle/l_itsallquiet.wav","nh2_swat/idle/l_itsdarkhere.wav"}
ENT.SoundTbl_Alert = {"nh2_swat/combat/l_ambush_combat.wav","nh2_swat/combat/l_fastones.wav"}
ENT.SoundTbl_Suppressing = {"nh2_swat/combat/l_igotone.wav","nh2_swat/combat/l_gettothechoppadoitnaugh_combat.wav","nh2_swat/combat/l_whatthehellisthatthing_combat.wav","nh2_swat/combat/l_whatthehellisthatthing_combat.wav"}
ENT.SoundTbl_Grenade = {"nh2_swat/combat/l_getdown_combat.wav"}
ENT.SoundTbl_Pain = {"nh2_swat/pain/pain01.wav","nh2_swat/pain/pain02.wav","nh2_swat/pain/pain03.wav","nh2_swat/pain/pain04.wav","nh2_swat/pain/pain05.wav","nh2_swat/pain/pain06.wav","nh2_swat/pain/pain07.wav","nh2_swat/pain/pain08.wav","nh2_swat/pain/pain09.wav","nh2_swat/idle/l_argh.wav","nh2_swat/idle/l_argh2.wav"}
...
ENT.SoundTbl_FollowPlayer = {"nh2_swat/idle/l_alrightletthemhaveit.wav","nh2_swat/idle/l_leadtheway.wav"}
ENT.SoundTbl_DamageByPlayer = {"nh2_swat/idle/l_stopshootingme.wav","nh2_swat/idle/l_watchit.wav"}
ENT.SoundTbl_OnPlayerSight = {"nh2_swat/l_wethoughtyouweredead.wav","nh2_swat/l_idontknowyou.wav","nh2_swat/l_welcomeback.wav","nh2_swat/l_welcomeback2.wav","nh2_swat/swatl_finalgoodluck.wav","nh2_swat/swatl_finalhospital.wav","nh2_swat/swatl_finalmysquad.wav","nh2_swat/swatl_finalthesamesignal.wav","nh2_swat/swatl_finalthissucks.wav","nh2_swat/swatl_thatwasclosethanks.wav"}
